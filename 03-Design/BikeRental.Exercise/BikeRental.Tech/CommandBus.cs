...
public class CommandBus
{
    ...
    public CommandBus(IServiceProvider serviceProvider, EventBus eventBus)
    {
    ...
    public void Handle<TCommand>(TCommand command)
    {
        ...
        foreach (object handler in handlers)
        {
            ...
            Console.WriteLine($"{Thread.CurrentThread.ManagedThreadId}: Publishing events from entities.");
            _eventBus.PublishEventsFromEntities();
        }
