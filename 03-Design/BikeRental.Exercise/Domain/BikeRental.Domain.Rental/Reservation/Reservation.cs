...
public record ReservationMade(ReservationId ReservationId, BikeId BikeId, ClientId ClientId, DateTimeOffset StartDate, DateTimeOffset ExpirationDate);
public record ReservationCancelled(ReservationId ReservationId, ClientId ClientId, DateTimeOffset CancellationDate);
public record ReservationExpired(ReservationId ReservationId, ClientId ClientId, DateTimeOffset ExpirationDate);
public record ReservationFinished(ReservationId ReservationId, ClientId ClientId, DateTimeOffset FinishDate);
